...
//        cout << "chunkdataHex: " << chunkdataHex << endl;
        ...
        if(length > 100) {
          ...
          for(long x = 0; x < length; x+=10){
            ...
            printf("   %02X", (unsigned char)comp[x+4]);
            
            printf("   %02X", (unsigned char)comp[x+5]);
            printf("   %02X", (unsigned char)comp[x+6]);
            printf("   %02X", (unsigned char)comp[x+7]);
            printf("   %02X", (unsigned char)comp[x+8]);
            printf("   %02X\n", (unsigned char)comp[x+9]);
          }
        }
        
        cout << "ucompSize: " << ucompSize << endl;
        cout << "compSize: " << compSize << endl << endl;
